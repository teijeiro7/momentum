        ...
        habits: await Promise.all(
          habits.map(async (habit) => {
            ...
            return {
              ...
              logs: logs.map((log) => ({
                ...log,
                date: new Date(log.date).toISOString(), // Ensure ISO format with full timestamp
              })),
            };
          })
        ),
    ...
    >
      ...
      >
        <p className="text-sm" style={{ color: "var(--text-primary)" }}>
          💡 <strong>Tip:</strong> Your data is yours! Export anytime, no
          limits. This is a premium feature that's completely free.
        </p>
      </div>
    </div>
  );
